...
= Hero Component =
    @on Desktop
        hero-head:
            inside screen  403 to 415px left
        ...
        hero-cta1:
            inside screen  745 to 755px left
    ...
    @on tablet
        ...
        hero-cta1:
            inside screen  254 to 265px left
    ...
    @on Mobile       
        hero-head:
            inside screen  145 to 156px left
        ...
        hero-cta1:
            inside screen  290 to 300px left
