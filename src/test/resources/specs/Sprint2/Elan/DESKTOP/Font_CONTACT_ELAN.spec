@objects
    ...
    MobContactleftSideContactNumber xpath  (//section[contains(@id,'contact-us')]//p/a[contains(@class,'contact-number')])[2]
    MobContactleftSideContactEmail  xpath  (//section[contains(@id,'contact-us')]//p/a[contains(@class,'email')])[2]      
...
= CONTACT US =
    @on Desktop
        ...
        ContactDropDown:
            ...
            box-shadow "1px 1px 7px 0 rgba(28, 57, 137, 0.2)"
            css font-size is "14px"
            css line-height is "18px"  
        ...
        ContactSubmitButton:  
            ...
            css background-color is "rgba(109, 32, 126, 1)"                                                  
