...
= CodeSnippet Component =
   @on Desktop
        ...
        CTA1:
                      ...
                      css color is "rgba(11, 19, 97, 1)"
                      css font-family matches "roboto-bold"
                      css background-color is "rgba(86, 160, 225, 1)"
        CTA2: 
                      right-of CTA1 ~ 23px
                      ...
                      css font-size is "14px"
                      css line-height is "16px"
                      css color is "rgba(86, 160, 225, 1)"
                      css font-family matches "roboto-bold"
