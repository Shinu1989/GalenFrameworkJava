@objects
    ...
    right-menuhead-items-*   xpath .//div[@class='header-right']/ul/li/a
...
= Header Component =
    @on Desktop
        ...
        for-developers:
            inside left-menu-head 145 to 155px left
    ...
    @on Desktop
        ...
        @forEach [right-menuhead-items-*] as menuItem, prev as previousMenuItem
            ${menuItem}:
                ...
                css font-size is "18px"
                css line-height is "21px"
                css color is "rgba(255, 155, 255, 1)"
                css font-family matches "roboto"
                css font-weight is "300"
...
= Hero Component =
    @on Desktop
        ...
        hero-head:
            inside screen 0px left, ~212px top
            css font-size is "50px"
            css line-height is "58px"
            css color is "rgba(255, 155, 255, 1)"
            css font-family matches "roboto"
            css font-weight is "100"
        ...
        hero-cta1:
            inside hero-banner 0px left
            below hero-para ~104 px
            css font-size is "14px"
            css line-height is "16px"
            css color is "rgba(223, 62, 75, 1)"
            css font-family matches "roboto-bold"
...
= CodeSnippet Component =
   @on Desktop
        ...
        CTA1:
                      ...
                      css font-family matches "roboto-bold"
        CTA2: 
                      right-of CTA1 20 to 23px
                      aligned horizontally all CTA1
                      below CodeSnippet ~ 22px
                      css font-size is "14px"
                      css line-height is "16px"
