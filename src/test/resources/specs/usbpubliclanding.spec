...
=  Highlights Component =
   @on Desktop
        ...
        Highlight2:
                  width 60 to 66px
                  height 98 to 104px
                  inside screen ~ 392px left
                  right-of Highlight1 ~ 191px


        Highlight3:
                  width 80 to 86px
                  height 80 to 86px
                  inside screen ~ 636px left
                  right-of Highlight2 ~ 182px


        Highlight4:
                  width 76 to 83px
                  height 76 to 83px
                  inside screen ~ 895px left
                  right-of Highlight3 ~ 177px
        ...
        HighlightTitle2:
                       ...
                       css font-size is "22px"
                       css line-height is "26px"
                       inside screen  305 to 311px left
                       below Highlight2 19 to 23px
                       right-of HighlightTitle1 ~ 23.97px
        HighlightTitle3:
                       width 226 to 232px
                       height 23 to 29px
                       css font-size is "22px"
                       css line-height is "26px"
                       inside screen ~ 562px left
                       below Highlight3 37px
                       right-of HighlightTitle2 ~ 25px
        HighlightTitle4:
                       width 226 to 232px
                       height 23 to 29px
                       css font-size is "22px"
        ...
        HighligtSumary2:
                       ...
                       css font-size is "14px"
                       css line-height is "18px"
                       inside screen ~ 306px left
                       below HighlightTitle2 14 to 19px
                       right-of HighligtSumary1 ~ 22px
        ...
        HighligtSumary3:
                       ...
                       css font-size is "14px"
                       css line-height is "18px"
                       inside screen ~ 563px left
                       below HighlightTitle3 14 to 19px
                       right-of HighligtSumary2 ~ 25px
        ...
        HighligtSumary4:
                       ...
                       css font-size is "14px"
                       css line-height is "18px"
                       inside screen ~ 816px left
                       below HighlightTitle3 14 to 19px
                       right-of HighligtSumary3 ~ 24px
...
= CodeSnippet Component =
   @on Desktop
        ...
        Tooltext:
                ...
                inside screen ~ 368px left
                below ToolSumry ~ 56px
 
        CodeSnippet:
               width  650 to 656px
               height 313 to 320px
               inside screen ~ 223px left
               below Tooltext ~ 31px
               css font-size is "14px"
