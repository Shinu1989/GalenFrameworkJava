...
= Header Component =
    @on Desktop
        header-container:
            ...
            height ~ 190px
            color-scheme > 90% #FFFFFF

        left-menu-head:
            inside header-container 0px left

        logo-img:
            inside left-menu-head 75px left, 60px top
            height ~ 41px

        for-developers:
            inside left-menu-head 298px left
            right-of logo-img 21 to 24px
            height ~ 21 px
...
= Menu Head =
    ...
    @on Desktop
        right-menuhead-items-1:
            inside right-menu-head 69px top
            right-of for-developers 336px
...
=  Highlights Component =
    @on Desktop
        ...
        Highlight2:
                  width 60 to 66px
                  height 98 to 104px
                  inside screen ~ 491px left
                  right-of Highlight1 ~ 242px
        ...
        Highlight3:
                  ...
                  right-of Highlight2 ~ 234px


        Highlight4:
                  width 76 to 83px
                  height 76 to 83px
                  inside screen ~ 1094px left
                  right-of Highlight3 ~ 225px
        ...
        HighlightTitle4:
                       ...
                       css font-size is "22px"
                       css line-height is "26px"
                       inside screen ~ 1014px left
                       below Highlight4 ~ 37px
                       right-of HighlightTitle3 ~ 45px
