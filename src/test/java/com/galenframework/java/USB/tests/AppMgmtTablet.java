...
public class AppMgmtTablet extends GalenTestBase {
    ...
    public void verify_usbAppMgmtPage(TestDevice device) throws IOException {
        ...
        checkLayout("/specs/Sprint2/USB/Tablet/AppMgmtPageUSB.spec", device.getTags());
    }
    ...
    public void verify_usbAppMgmtCreate(TestDevice device) throws IOException {
        ...
        checkLayout("/specs/Sprint2/USB/Tablet/AppMgmtCreateAppUSB.spec", device.getTags());
    }
    ...
    public void verify_usbAppMgmtDetails(TestDevice device) throws IOException {
        ...
        checkLayout("/specs/Sprint2/USB/Tablet/AppManagementAppDetails.spec", device.getTags());
    }
    ...
    public void verify_usbAppMgmtDeleteApp(TestDevice device) throws IOException {
        ...
        checkLayout("/specs/Sprint2/USB/Tablet/AppMgmtDeleteApp.spec", device.getTags());
    }
